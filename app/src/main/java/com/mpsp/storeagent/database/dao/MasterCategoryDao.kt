...
interface MasterCategoryDao {
    ...
    @Query("SELECT id FROM MasterCategory WHERE MasterCategory.title = :masterCategoryTitle")
    suspend fun getMasterCategoryIdByTitle(masterCategoryTitle: String): String?
}